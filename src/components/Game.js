...
export class Game extends Component {
    handleLoadGame = dispatch => {
        ...
        const getRandomGameData = () => {
            ...
            const drawedNumber = Math.floor(Math.random() * (games.length - 1));
            return {
                quizz: games[drawedNumber][0],
                solution: games[drawedNumber][1]
            };
        };
        ...
        dispatch({
            type: "LOAD_GAME",
            payload: convertGameStringsToBoardaData(getRandomGameData()) //sends board data as payload
        });
    };
